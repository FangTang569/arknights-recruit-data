...
## 写在最后
- 想做点练手小东西写点垃圾代码的时候发现，公招干员的数据好像没有什么现成的开源数据，于是自己爬了一下（不过这个也只是抓了PRTS现成的数据而已，没有什么技术含量）
- 爬虫脚本不会自动更新数据，如果游戏更新了可以发issue，我看到之后就会更（但是公招更新频率本来就很低就是了）
- 感谢PRTS wiki的贡献者们，感谢他们辛苦维护的干员数据